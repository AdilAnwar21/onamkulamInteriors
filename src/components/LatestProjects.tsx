...
const TeamSection = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      role: "Penthouse",
      image:
        "https://images.unsplash.com/photo-1519985176271-adb1088fa94c?w=600&h=400&fit=crop",
      isLarge: true,
  ...
  return (
    <div className="h-screen w-full bg-gray-50 overflow-hidden flex items-center justify-center" ref={sectionRef}>
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* Header */}
        <div className={`mb-3 sm:mb-6 md:mb-8 transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
          ...
          <div className={`lg:col-span-4 flex flex-col justify-center transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}>
          ...
          <div className={`lg:col-span-8 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'
            }`}>
            <div className="grid grid-cols-2 md:grid-cols-6 gap-2 sm:gap-3">

              {/* Top Row - 3 team member cards */}
              <div className={`col-span-1 md:col-span-2 transition-all duration-700 delay-600 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
                }`}>
                <div
              ...
              <div className={`col-span-1 md:col-span-2 transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
                }`}>
                <div
                  className="relative rounded-lg sm:rounded-xl overflow-hidden h-32 sm:h-48 md:h-52 cursor-pointer transition-all duration-300 group"
              ...
              <div className={`col-span-2 md:col-span-2 transition-all duration-700 delay-800 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
                }`}>
                <div
                  className="relative rounded-lg sm:rounded-xl overflow-hidden h-32 sm:h-48 md:h-52 cursor-pointer transition-all duration-300 group"
              ...
              {/* Bottom Row */}
              <div className={`col-span-2 md:col-span-4 transition-all duration-700 delay-900 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
                }`}>
                <div
              ...
              <div className={`col-span-2 md:col-span-2 flex flex-col gap-2 sm:gap-3 transition-all duration-700 delay-1000 ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'
                }`}>
                {/* Tanya */}
                <div
